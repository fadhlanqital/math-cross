...
namespace stickin.mathcross
{
    public class LevelsGenerator
    {
        ...
        public LevelModel Generate(DifficultParams difParams)
        {
            var levelModel = GenerateBoard(difParams.Size.x, difParams.Size.y, difParams.MaxNumber, 20);
            levelModel.CellToPocket(difParams.PercentageNumbersToPocket, difParams.PercentageRewards);
