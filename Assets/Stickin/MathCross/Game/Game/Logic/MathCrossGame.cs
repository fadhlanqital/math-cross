...
namespace stickin.mathcross
{
    public class MathCrossGame : Game
    {
            ...
            IGameView gameView)
        {
            ...
            var rewardResourceModule = new RewardResourceModule(ResourcesService.CoinKey, rewardResource);
            ...
            gameView.Init(_difficult, _board, _pocket, rewardResourceModule, _config.GetCustomConfig<DifficultsConfig>().GetDifficult(_difficult).Title);
