...
namespace stickin.mathcross
{
    ...
    public class MathCrossSavable : ASavable, IGameModule
    {
        ...
        public MathCrossSavable(int levelNumber, LevelsProgressService levelsProgressService) : base(levelNumber, levelsProgressService)
        {
        }

        public void Init(int difficult, Board board, Pocket pocket, GameTimer timer, RewardResourceModule rewardResourceModule)
        {
