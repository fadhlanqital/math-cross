...
namespace stickin.mathcross
{
    public class MathCrossGameView : GameView, IGameView
    {
        ...
        [SerializeField] private TextLocalization _difficultText;
        ...
        public override void InitWithLevelNumber(GameParams gameParams)
        {
            ...
            if (gameParams.CustomData != null && gameParams.CustomData.ContainsKey("difficult"))
                difficult = (int) gameParams.CustomData["difficult"];
        ...
        public void Init(int difficult, Board board, Pocket pocket, RewardResourceModule rewardResourceModule, string difficultTitle)
        {
            _difficultText.SetText( difficultTitle);
